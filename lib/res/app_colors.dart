...
class AppColors extends MaterialColor {
  ...
  static const int primaryColorValue = 0xFF250D2B;

 // static const primaryColor = Color(0xFFE0F2F1);
  static const primaryColor = Color(0xbcc0b);
  static const primaryColor10 = Color(0x01142b);
  static const primaryLightYellow = Color(0xFFcba165);
  //Sixteen digit project colors

  static const darkcolor = Color(0xFF01142b);
  static const lightcolor = Color(0xFF002860);



  static const colorTransparent = Color(0x00000000);
  static const halfwhite = Color(0xF2F2f2);
  ...
  static const container = Color(0xFFA4C9E0);
  ...
  static const tabindicator_grey = Color(0xFFC6C9D1);
  ...
  static const training_color_6 = Color(0xFFF8FDFF);
